...
<head>
  ...
  <title>TechStash Blogs Setting</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" id="table" data-accordion="false">
		  ...
		  <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="blog_setting" class="nav-link active">
                  <i class="fas fa-cogs nav-icon"></i>
                  <p>Blog Settings</p>
                </a>
              </li>
...
<div class="modal fade" id="modal-default">
    ...
    <section class="content">
     <form:form action="blogsettingupdate" modelAttribute="blog_setting" method="POST">
      <div class="card">
