...
<head>
  ...
  <title>TechStash Post Job Setting</title>
...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" id="table" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="postjob_setting" class="nav-link active">
                  <i class="fas fa-cogs nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <form:form action="postjobsettingupdate" modelAttribute="postjob_setting" method="POST">
      <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-3">
