...
<head>
  ...
  <title>TechStash Post Blog Setting</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" id="table" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="postblog_setting" class="nav-link active">
                  <i class="fas fa-cogs nav-icon"></i>
...
<div class="modal fade" id="modal-default">
    ...
    <form:form action="postblogsettingupdate" modelAttribute="postblog_setting" method="POST">
      <div class="card">
