...
<head>
  ...
  <title>TechStash PrivacyPolicy Setting</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" id="table" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="privacypolicy_setting" class="nav-link active">
                  <i class="fas fa-cogs nav-icon"></i>
...
<div class="modal fade" id="modal-default">
    ...
    <form:form action="privacypolicysettingupdate" modelAttribute="privacypolicy_setting" method="POST">
      <div class="card">
