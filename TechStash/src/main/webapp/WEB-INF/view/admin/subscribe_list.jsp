...
<head>
  ...
  <title>TechStash Subscriber List</title>
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="subscribe_list" class="nav-link active">
                  <i class="far fa-file-alt nav-icon"></i>
                  <p>Subscribe List</p>
                </a>
              </li>
              ...
              <div class="card-body">
                <table id="searchtable" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th>Subscribe to events, hackthons, conference</th>
                    <th>Subscribe to podcast</th>
                  </tr>
                  </thead>
                  <tbody>
                  <tr>
