...
<head>
  ...
  <title>TechStash Resources Setting</title>
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" id="table" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="resource_setting" class="nav-link active">
                  <i class="fas fa-cogs nav-icon"></i>
...
<div class="modal fade" id="modal-default">
    ...
    <section class="content">
     <form:form action="resourcesettingupdate" modelAttribute="resource_setting" method="POST">
      <div class="card">
