...
<head>
  ...
  <title>TechStash Podcast Setting</title>
...
<div class="wrapper">
     ...
     <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" id="table" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="podcast_setting" class="nav-link active">
                  <i class="fas fa-cogs nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     <form:form action="podcastsettingupdate" modelAttribute="podcast_setting" method="POST">
      <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-3">
