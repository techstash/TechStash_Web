...
<head>
  ...
  <title>TechStash Podcast Content</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" id="table" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="podcast_content" class="nav-link active">
                  <i class="far fa-file-alt nav-icon"></i>
                  <p>Podcast Content</p>
                </a>
              </li>
...
<div class="modal fade" id="modal-default">
    ...
    <form:form action="saveheadersectionpodcast" method="POST" modelAttribute="header_section" enctype="multipart/form-data">
