    ...
    <div class="row">
          <div class="col-lg-12  grid-margin">
            ...
            <br>
              ...
              <br>
                <p style="color:black;">Broadly speaking, Information Technology (IT) includes everything having to do with computers, from the machines on peopleâs desks to the servers and network equipment used to tie it all together. This can include non intuitive links, like computerized telephones that cause a customers information to automatically appear on a users screen when they accept a call, and phone systems that automatically 
...
Broadly speaking, Information Technology (IT) includes everything having to do with computers, from the machines on peopleâs desks to the servers and network equipment used to tie it all together. This can include non intuitive links, like computerized telephones that cause a customers information to automatically appear on a users screen when they accept a call, and phone systems that automatically route calls to particular users depending on identifying information entered by the user, which is used to determine which employee talked to that user last.
Broadly speaking, Information Technology (IT) includes everything having to do with computers, 

Broadly speaking, Information Technology (IT) includes everything having to do with computers, from the machines on peopleâs desks to the servers and network equipment used to tie it all together. This can include non intuitive links, like computerized telephones that cause a customers information to automatically appear on a users screen when they accept a call, and phone systems that automatically route calls to particular users depending on identifying information entered by the user, which is used to determine which employee talked to that user last. Broadly speaking, Information Technology (IT) includes everything having to do with computers, from the machines on peopleâs desks to the servers and network equipment used to tie it all together. This can include non intuitive links, like computerized telephones that cause a customers information to automatically appear on a users screen when they accept a call, and phone systems that automatically route calls to particular users depending on identifying information entered by the user, which is used to determine which employee talked to that user last. Broadly speaking, Information Technology (IT) includes everything having to do with computers, from the machines on peopleâs desks to the servers and network equipment used to tie it all together. This can include non intuitive links, like computerized telephones that cause a customers information to automatically appear on a users screen when they accept a call, and phone systems that automatically route calls to particular users depending on identifying information entered by the user, which is used to determine which employee talked to that user last.               
