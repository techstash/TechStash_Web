    ...
    <div class="row">
          <div class="col-lg-12  grid-margin">
            ...
            <br>
              ...
              <br>
                <p style="color:black;">Broadly speaking, Information Technology (IT) includes everything having to do with computers, from the machines on people desks to the servers and network equipment used to tie it all together. This can include non intuitive links, like computerized telephones that cause a customers information to automatically appear on a users screen when they accept a call, and phone systems that automatically 
