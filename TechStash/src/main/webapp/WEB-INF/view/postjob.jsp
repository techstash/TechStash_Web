...
<div class="page-wrapper p-t-100 p-b-50">
        ...
        <h2 class="section-title">Submit Job</h2>
    			</div>
                <div class="card-body card border-0 shadow rounded-lg">
                    <form method="POST">
                        ...
                        <div class="form-row">
                            <div class="name">Job Title <span class="required-color"> * </span></div>
                            <div class="value">
                                <input class="input--style-6" type="text" name="name" placeholder="" required>
                            </div>
                        </div>
                         <div class="form-row">
                            <div class="name">Job Description <span class="required-color"> * </span></div>
                            <div class="value">
                                <div class="input-group">
                        ...
                        <div class="form-row">
                         ...
                         <div class="form-row">
                            <div class="name">Job Type <span class="required-color"> * </span></div>
                            <div class="value">
                                <input class="input--style-6" type="text" name="name" placeholder="" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="name">Logo Upload <span class="required-color"> * </span></div>
                            <div class="value">
