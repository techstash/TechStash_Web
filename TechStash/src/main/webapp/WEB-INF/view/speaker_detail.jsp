...
<section class="page-alignment-speakers-details section-lg-bottom">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <img src="images/speakers/speaker-2.jpg" alt="Speaker 1" class="img-fluid img-alignment-speakers img-circle">
          </div>
