...
<script src="http://maximeh.github.io/leaflet.bouncemarker/bouncemarker.js"></script>
  ...
  /*  var map = L.map('map').setView([21.0000, 78.0000], 4);
   ...
   var popup = marker.bindPopup(template);
   
   var marker1 = L.marker([28.610001, 77.230003]).addTo(map);
   var popup1 = marker1.bindPopup(template);
   
   var marker1 = L.marker([22.5726, 88.3639]).addTo(map);
   var popup1 = marker1.bindPopup(template);
   
   var marker1 = L.marker([19.0760, 72.8777]).addTo(map);
   var popup1 = marker1.bindPopup(template);
   
   var marker1 = L.marker([22.2587, 71.1924]).addTo(map);
   var popup1 = marker1.bindPopup(template); */
