...
<section class="page-title page-title-overlay bg-cover overflow-hidden" data-background="images/background/blog.jpg">
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                <h1 class="text-white position-relative" data-aos="fade-up" data-aos-delay="1000">Blogs<span class="watermark-sm">Blog</span></h1>
                <p class="text-white pt-4 pb-4" data-aos="fade-up" data-aos-delay="1200">We publish curious and insightful technologists without pop up ads, paywalls, or a lengthy review process. </p>
            </div>
            <div class="col-lg-5 pl-lg-0 pt-5 pt-lg-0 text-lg-right text-center">
        <img src="images/blog/blog-banner.svg" class="img-fluid" alt="banner-image" data-aos="zoom-in" data-aos-delay="1500">
      </div>
        </div>
    </div>
</section>
    ...
    <div class="row masonry-container">
      ...
      <div class="card border-0 shadow rounded-lg">
        <article class="text-center">
          ...
          Few Wordings Here Few Wordings Here Few Wordings Here Few Wordings Here Few Wordings Here Few Wordings Here</p>
              </div>
            </div>
        </article>
        </div>
